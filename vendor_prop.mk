PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.com.google.clientidbase=android-caron \
    ro.com.google.gmsversion=8.1_201808.go \
    ro.config.alarm_alert=Oxygen.ogg \
    ro.config.default_message0=Hangouts_message.ogg \
    ro.config.default_message1=Highwire.ogg \
    ro.config.default_message=Hangouts_message.ogg \
    ro.config.low_ram=true \
    ro.config.notification_sound=Hangouts_message.ogg \
    ro.config.ringtone0=SIM1-Hangouts_imcoming_call.ogg \
    ro.config.ringtone1=Ring_Synth_02.ogg \
    ro.config.ringtone=SIM1-Hangouts_imcoming_call.ogg \
    ro.control_privapp_permissions=log \
    ro.hardware.keystore=sprdtrusty \
    ro.hotspot.enabled=1 \
    ro.keybox.id.value=HERO_12 \
